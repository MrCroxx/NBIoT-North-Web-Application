...
public interface AlarmRepository extends JpaRepository<Alarm, Long> {
    ...
    @Query("SELECT a FROM  Alarm a JOIN a.device d WHERE d.owner=:user AND a.status=:status ORDER BY a.dateOfAlarm")
    ...
    @Query("SELECT a FROM  Alarm a JOIN a.device d WHERE d.owner=:user ORDER BY a.dateOfAlarm")
